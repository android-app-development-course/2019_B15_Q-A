...
/**
 * A simple extension of a regular linear ic_mail2 that supports the divider API
 * of Android 4.0+. The dividers are added adjacent to the children by changing
 * their ic_mail2 params. If you need to rely on the margins which fall in the
 * same orientation as the ic_mail2 you should wrap the child in a simple
